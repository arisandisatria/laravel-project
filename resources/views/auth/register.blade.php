...
<div class="card shadow border-0 rounded-4">
  <div class="card-body p-4 p-md-5">
    ...
    <div class="text-center mb-5">
      ...
      <p class="text-muted small">Satu langkah menuju manajemen resep dan obat yang lebih efisien.</p>
    </div>
    ...
    <form method="POST" action="#">
      ...
      <div class="mb-3">
        ...
        <input id="password" type="password" class="form-control bg-light border-0 py-2" name="password" required placeholder="Minimal 8 karakter">
      </div>

      <div class="mb-4">
        <label for="password_confirmation" class="form-label fw-semibold text-secondary">Konfirmasi Kata Sandi</label>
        <input id="password_confirmation" type="password" class="form-control bg-light border-0 py-2" name="password_confirmation" required placeholder="Ulangi kata sandi">
      </div>
      ...
      <div class="text-center mt-4">
        <span class="text-muted small">Sudah terdaftar?</span>
