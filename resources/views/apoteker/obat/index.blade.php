    ...
    <div class="table-responsive">
      <table class="table align-middle mb-0 text-nowrap">
        <thead class="bg-light">
          <tr>
            <th class="ps-3 ps-md-4 py-3 border-0 text-muted small text-uppercase">Kode</th>
        ...
        <tbody>
          ...
          <tr class="{{ $item->stok < 10 ? 'table-danger bg-opacity-10' : '' }}">
            <td class="ps-3 ps-md-4 text-muted small">{{ $item->kode_obat }}</td>
            <td>
              ...
              <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-body p-4 text-center">
                  ...
                  <div class="d-flex flex-column gap-2 align-items-center mt-4">
                    <form action="{{ route('stok-obat.destroy', $item->id) }}" method="POST" class="w-100">
                      @csrf @method('DELETE')
