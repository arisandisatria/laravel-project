        ...
        <div class="card-body p-4">
          <div class="row align-items-center">
            <div class="col-md-8">
              ...
              <h4 class="fw-bold mb-1 mt-1">{{ $rm->pasien->user->name }}</h4>
              <p class="mb-0 text-white small">
                <i class="bi bi-fingerprint me-1"></i> ID: PAS-{{ str_pad($rm->pasien_id, 3, '0', STR_PAD_LEFT) }} &nbsp; • &nbsp;
                <i class="bi bi-gender-male me-1"></i> {{ $rm->pasien->jenis_kelamin }} &nbsp; • &nbsp;
                <i class="bi bi-calendar3 me-1"></i> {{ \Carbon\Carbon::parse($rm->pasien->tanggal_lahir)->age }} Tahun
              </p>
            </div>
            ...
            <div class="row g-4 align-items-start">
                ...
                <div class="row g-3">
                  <div class="col-md-4">
                    ...
                    <div class="input-group input-group-sm">
                      <input type="text" class="form-control border-0 bg-light" name="tensi" placeholder="120/80" value="{{ $rm->tensi ?? '' }}">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group input-group-sm">
                      <input type="text" class="form-control border-0 bg-light" name="suhu" placeholder="36.5" value="{{ $rm->suhu ?? '' }}">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group input-group-sm">
                      <input type="text" class="form-control border-0 bg-light" name="berat_badan" placeholder="65" value="{{ $rm->berat_badan ?? '' }}">
              ...
              <div class="col-12 mt-4">
                <div class="d-flex justify-content-between pt-3 border-top">
                  <div class="col-md-2">
                    <a href="{{ route('dokter.pasien') }}" class="btn btn-light w-100 rounded-pill py-2 text-muted fw-medium">
                      Batal
                    </a>
                  </div>
                  <div class="col-md-5">
